...
public class Lista2 extends Activity implements OnCheckedChangeListener {
	CheckBox checkBox1;
	CheckBox checkBox2;
	CheckBox checkBox3;
	CheckBox checkBox4;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lista2_layout);
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		if (checkBox1.isChecked() && checkBox2.isChecked()
			...
			&& checkBox9.isChecked() && checkBox10.isChecked()) {
				AlertDialog.Builder dialog = new AlertDialog.Builder(Lista2.this);
